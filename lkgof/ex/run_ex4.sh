...
#screen -S ex4_kmod -X screen -t tab1 bash -lic "conda activate lkgof;python ex4_vary_mcsizes.py lda_h0_dx50_v1000_t3_p05q1temp1e-1"
# screen -S ex4_kmod -X screen -t tab1 bash -lic "conda activate lkgof;python ex4_vary_mcsizes.py lda_h0_dx50_v1000_t3_p05q1temp1"
# screen -S ex4_kmod -X screen -t tab1 bash -lic "conda activate lkgof;python ex4_vary_mcsizes.py lda_h1_dx50_v1000_t3_p1q05temp1"
