...
screen -S ex5_kmod -X screen -t tab1 bash -lic "conda activate lkgof;python ex5_kernel_params.py lda_h1_dx50_v10000_t3_p1q05temp1e-1"
...
# screen -S ex5_kmod -X screen -t tab1 bash -lic "conda activate lkgof;python ex5_kernel_params.py isogdpm_h1_dx10_tr5_p12e-1_q1"
# screen -S ex5_kmod -X screen -t tab1 bash -lic "conda activate lkgof;python ex5_kernel_params.py isogdpm_h1_dx10_tr5_p9e-1_q1"
